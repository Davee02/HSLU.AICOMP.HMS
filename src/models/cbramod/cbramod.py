...
from src.models.cbramod.criss_cross_transformer import (
    TransformerEncoder,
...
if __name__ == "__main__":
    ...
    model = CBraMod(in_dim=200, out_dim=200, d_model=200, dim_feedforward=800, seq_len=30, n_layer=12, nhead=8).to(
        device
    )
